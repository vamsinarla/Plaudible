package com.vn.plaudible.dragdrop;
...
public class DragNDropListView extends ListView {
	...
	private void startDrag(int itemIndex, int y) {
		...
		mDragItemView = getChildAt(itemIndex);
		if (mDragItemView == null) return;
		mDragItemView.setDrawingCacheEnabled(true);
		if (mDragListener != null)
			mDragListener.onStartDrag(mDragItemView);
	...
	private void stopDrag(int itemIndex) {
		if (mDragView != null) {
			if (mDragListener != null)
				mDragListener.onStopDrag(mDragItemView);
